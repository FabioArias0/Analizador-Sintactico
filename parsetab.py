...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression','parser.py',5),
  ('expression -> expression MINUS term','expression',3,'p_expression','parser.py',6),
  ('expression -> term','expression',1,'p_expression','parser.py',7),
  ('term -> term TIMES factor','term',3,'p_term','parser.py',17),
  ('term -> term DIVIDE factor','term',3,'p_term','parser.py',18),
  ('term -> factor','term',1,'p_term','parser.py',19),
  ('factor -> NUMBER','factor',1,'p_factor','parser.py',29),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','parser.py',30),
]
